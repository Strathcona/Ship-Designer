...
public class ConversationElement {
    ...
    public ConversationElement(string _text, ConversationElement _next=null) {
        ///<summary>
    ...
    public ConversationElement(string _setKey, bool _setValue, ConversationElement _next=null) {
        ///<summary>
    ...
    public ConversationElement(List<string> _choices, List<string> _responseKeys, List<bool> _responseValues, ConversationElement _next=null) {
        ///<summary>
    ...
    public ConversationElement(List<List<string>> _branchVariables, List<List<bool>> _branchConditions, List<int> _branchResults, ConversationElement _next=null) {
        ///<summary>
